...
void FAST_FUNC bb_error_msg_and_die(const char *s, ...){ return; }
void FAST_FUNC bb_show_usage(void) { return; }
...
/// End of functions needed for Vi ///

//// ** FULL Busybox implementation of mingw.c
